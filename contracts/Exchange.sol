...
contract Exchange {
    ...
    function fillOrder(uint256 _id) public {
        ...
        require(_id > 0 && _id <= orderCount, "Inavlid order id");
    ...
    function _trade(
        ...
        //Fee logic...
        //Fee is paid by the one who fills the order (msg.sender)
        ...
        //msg.sender is the one who filled the order and _user is the one who created the order
        tokens[_tokenGet][msg.sender] =
            tokens[_tokenGet][msg.sender] -
            (_amountGet + _feeAmount);
        tokens[_tokenGet][_user] = tokens[_tokenGet][_user] + _amountGet;

        //Transferring _feeAmount to feeAccount (charge fee)
